...
class RedstoneWire extends RedstoneSource{
    ...
    public function activate(array $ignore = []){
        if($this->canCalc()){
            ...
            $this->checkTorchOn($block, [$this->getOppositeSide($side[0])]);
    ...
    public function deactivate(array $ignore = []){
        if($this->canCalc()){
            ...
            $this->checkTorchOff($block, [$this->getOppositeSide($side[0])]);
            unset($connected, $notConnected);
        }
    }
    ...
    public function place(Item $item, Block $block, Block $target, $face, Vector3 $vector3, Player $player = null) : bool{
        $down = $this->getSide(Vector3::SIDE_DOWN);
